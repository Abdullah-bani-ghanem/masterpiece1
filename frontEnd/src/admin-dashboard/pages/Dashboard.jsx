...
//   // Status badge component
//   const StatusBadge = ({ status }) => {
//     // إذا كانت القيمة غير موجودة، نعرض حالة "غير محددة"
//     if (!status) {
//       return (
//         <span className="flex items-center px-2 py-1 text-xs font-medium rounded-full text-gray-500 border border-gray-200">
//           No Status Available
//         </span>
//       );
//     }
  
//     // التعديل على الشارات والأيقونات
//     const badges = {
//       approved: "bg-green-100 text-green-800 border-green-200",
//       pending: "bg-yellow-100 text-yellow-800 border-yellow-200",
//       rejected: "bg-red-100 text-red-800 border-red-200",
...
//     // التأكد من وجود الشارة المناسبة
//     if (!badges[status]) {
//       return (
//         <span className="flex items-center px-2 py-1 text-xs font-medium rounded-full text-gray-500 border border-gray-200">
//           Invalid Status
...
//     return (
//       <span
//         className={`flex items-center px-2 py-1 text-xs font-medium rounded-full border ${badges[status]}`}
//       >
//         {icons[status]}
//         {status.charAt(0).toUpperCase() + status.slice(1)}
//       </span>
...
//                           <td className="px-6 py-4 whitespace-nowrap">
//                             <div className="text-sm text-gray-500">{car.userName} <br /> {car.userEmail} <br /> {car.userPhone}</div>
//                           </td>
