...
const BikeDetails = () => {
    ...
    const handleAddToWishlist = async () => {
        try {
            ...
            const newItem = {
                type: "motorcycle", // أو "bike" حسب تصنيفك
                name: bike.name,
                model: bike.model,
                year: bike.year,
            ...
            Swal.fire({
                ...
                confirmButtonColor: '#10B981', // لون أخضر
            });
            ...
            Swal.fire({
                icon: 'error',
                title: 'Error',
                text: 'Something went wrong while adding to your wishlist.',
            });
        }
    };
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-black">
                <div className="text-amber-300 text-xl font-serif">
                    Bike not found or data unavailable
                </div>
            </div>
        );
    }
    ...
    const handleDeleteComment = async (commentId) => {
        try {
            ...
            // Use the correct path with :commentId
                ...
                <div className="bg-gray-900 rounded-xl overflow-hidden shadow-2xl border border-gray-800">
                    ...
                    <div className="relative">
                        ...
                        <button
                            ...
                            className="absolute bottom-6 right-6 bg-green-600 hover:bg-green-700 text-white px-5 py-2 rounded-full text-sm font-semibold shadow-lg transition-all duration-300"
                        >
                            Add to Wishlist
                        </button>
                            ...
                            <div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex justify-between items-center border-b border-gray-700 pb-3">
                                        ...
                                        <span className={`font-medium ${bike.status === 'approved' ? 'text-emerald-400' :
                                            bike.status === 'rejected' ? 'text-red-400' : 'text-green-500'
                                            }`}>
                                            ...
                                            {editingCommentId === comment._id ? (
                                                <div className="flex flex-col mb-4">
                                                    <textarea
                                                        ...
                                                        className="w-full h-24 p-3 text-white bg-gray-700 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
                                                    ></textarea>
