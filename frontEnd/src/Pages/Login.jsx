    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        >
          ...
          <motion.div className="text-center" variants={itemVariants}>
            ...
            <p className="mt-2 text-sm text-gray-400">
              ...
              <Link to="/register" className="font-medium text-green-400 hover:text-green-300 transition-colors duration-200">
                Sign up now
              </Link>
            </p>
          </motion.div>
        ...
        >
          ...
          />
          <motion.div 
            className="absolute w-40 h-40 rounded-full bg-green-500 opacity-20" 
